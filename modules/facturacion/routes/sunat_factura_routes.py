...
@bp.route('/sunat_factura/<string:uniqueid>')
def sunat_factura(uniqueid):
    ...
    try:
        ...
        invoice = {
            ...
            'tipoDoc': operacion.tipo_comprobante,  # Factura - Catalogo.01
        ...
        print(invoice)
        # Enviar factura
        bill_result = SunatModel.send_invoice_venta(invoice)
        ...
        # Guardar CDR
        cdr_filename = f"R-{SunatModel.getValor(configuracion, 'ruc')}-01-{operacion.serie}-{operacion.correlativo}.zip"
