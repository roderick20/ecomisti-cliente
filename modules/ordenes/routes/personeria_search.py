...
@bp.route('/search_dni/<numero>', methods=['GET'])
def search_dni(numero):
    print(f"Este es el numero: {numero}")


    personeria = OrdenModel.get_by_numero_doc(numero)
    ...
    if len(personeria['data']) == 1 :        
        ...
        try:
            ...
            if response_v1.status_code == 200:
                ...
                personeria = OrdenModel.create_dni(
                razon_social, 
...
@bp.route('/search_ruc/<numero>', methods=['GET'])
def search_ruc(numero):
    ...
    if len(personeria['data']) == 1 :        
        ...
        try:
            ...
            personeria = OrdenModel.create_ruc(
